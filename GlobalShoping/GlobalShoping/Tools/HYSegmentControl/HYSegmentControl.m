...
- (void) addTitleSource:(NSMutableArray *)titleSource bottomLineColor:(UIColor*)bottomLineColor{
    ...
    // 创建指示器
    self.bottomLine =[[UIView alloc]initWithFrame:CGRectMake(0, self.bounds.size.height - BOTTOMLIINEHEIGHT, [[self.btnFrames valueForKey:@"0"] CGRectValue].size.width, BOTTOMLIINEHEIGHT)];
